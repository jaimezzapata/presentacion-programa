        ...
        <div className="submodulo-parent">
            <div className="submodulo-div1">
                <section>
                    ...
                    <small>Norma de competencia: 220501131 Levantar requisitos de la solución de software de acuerdo con métodos y estándares técnicos </small>
                    <p><strong>Objetivo:</strong><small>Desarrollar competencias basicas relacionadas al manejo de proceos, levantamientos de requistos e información, documentación y trabajo colaborativo</small></p>
                </section>
                <section>
                    <p>El presente submódulo aborda temas básicos de análisis y levantamiento de requisitos para la solución de una necesidad. Se abordan temas de documentación y construcción de informes como punto de partida para el desarrollo</p>
                    <p>Igualmente se aborda el concepto de trabajo agile enfocado en la metodología SCRUM</p>
                </section>
            </div>
